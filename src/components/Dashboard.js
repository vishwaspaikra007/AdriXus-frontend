  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.options}>
        ...
        <input placeholder='search' type="text" name="search" onChange={(e) => handleSearch(e)} />
      </div>
      <div className={styles.table}>
        ...
        {page[pageNo] && page[pageNo].map((obj, idx) => {
          return (
      ...
      <div className={styles.pagination}>
            ...
            <button onClick={() => setPageNo(pageNo+1)} disabled={Object.keys(page).length-1 <= pageNo}>Next</button>
      </div>
    </div>
  )
}
